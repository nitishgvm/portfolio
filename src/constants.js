...
export const techStack = [
  ...
  { name: "MySQl", link: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mysql/mysql-original-wordmark.svg" },
...
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/nitesh_17_09/' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/nitishgvm'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/nitish-singh-124a83220/'}
]
...
export const projectData = [
  ...
  {
    name: 'HDFC Life Call Vault',
    desc: 'HDFC Life is a long-term life insurance provider with its headquarters in Mumbai, offering individual and group insurance services. HDFC Life faced a significant challenge in managing their call records due to the large volume (over 1 lakhs) generated weekly from various call centers. They used to store these records on physical hard drives in different locations, making it difficult to access and maintain them effectively. To address this, We suggested a solution of storing the records in the cloud using AWS S3 bucket, allowing easy access. We also created a user-friendly platform for our client to access and manage these records efficiently through a Call Center Dashboard Application.',
    img: hdfc,
    url: 'https://callv.hdfclife.com/'
  },
  {
    name: 'Cloud Lifecycle Management',
    desc: 'CLM is for business user, with help of Dashboard they can get quick insights about resources / cost for a specific account con-figured in the tool. It also helps engineer’s & other user in monitoring all the resources. Primary objective is to sharing insights of optimizing cost, manage security and vulnerability and governance of cloud resource used.',
    img: clm,
    url: 'http://clm.acc.ltd.s3-website.ap-south-1.amazonaws.com/'
  },
]